              ...
              <div className="middle-section">
                <div className="icon-and-details">
                  ...
                  <div>
                    <p>
                      Name:{sheep.name}
                      {/* Put 109-112 on registration, customer, etc */}
                      {/* Name:{" "} */}
                      {/* <Link to={{ pathname: `/sheep/${sheep.ear_tag_id}` }}>
                        {sheep.name}
                      </Link> */}
                    </p>
                    <Link
                    ...
                    >
                      <h3>
                        Org name does not exist within sheep, make new api call
                ...
                <div className="flex-row">
                  <SecurityWrapper restrict_roles="sheep">
                    <button
                      ...
                      onClick={() =>
                        redirectTo(`/sheep-form/${sheep.ear_tag_id}`)
                      }
                    >
                      Edit
                    </button>
